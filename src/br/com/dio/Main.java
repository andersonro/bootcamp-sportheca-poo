...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Conteudos escritos " + dev1.getNome() + " "+ dev1.getConteudosInscritos());
        dev1.progredir();
        dev1.progredir();
        System.out.println("");
        System.out.println("Conteudos concluídos " + dev1.getNome() + " "+ dev1.getConteudosConluidos());
        System.out.println("Conteudos escritos " + dev1.getNome() + " "+ dev1.getConteudosInscritos());
